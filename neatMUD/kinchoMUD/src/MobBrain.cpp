...
//	{
		...
		else
		{
			...
			// new_id ???
			// inputs for self: party position, container stats, ?buffs?
			// inputs for others: mob family id, container stats (ie hp, mp, etc)
			// outputs: 1 for each action, plus an additional target output range
			// nmax: somewhat arbitrary choice, twice the # of outputs
			// r: why the hell not?
...
//	else
//	{
//		//Do something super smart here
//		//Swordchucks smart
//		//Coz swordchucks are EPIC
...
//	Organism *new_org;
//
//	if (orgd >= 0 && orgd < pop->organisms.size())
//	{
...
//
////			string popName = "data/mobs/ai/" + mobName + ".pop";
////			ofstream ofpopName(popName.c_str());
////			pop->print_to_file_by_species(ofpopName);
//		}
//	}
}
