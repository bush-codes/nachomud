    ...
    <div className="flex items-center gap-4 px-4 py-2 bg-gray-900 rounded-lg border border-gray-800">
      ...
      <div className="flex items-center gap-1">
        <button
          onClick={() => onSetTick(1)}
          disabled={disabled}
          className="px-2 py-1 text-sm text-gray-300 hover:text-white hover:bg-gray-700 rounded disabled:opacity-30 disabled:cursor-not-allowed"
          title="Jump to start"
        >
          |&lt;
        </button>
        ...
        <button
          ...
          disabled={disabled}
          className="px-3 py-1 text-sm font-bold text-gray-300 hover:text-white hover:bg-gray-700 rounded disabled:opacity-30 disabled:cursor-not-allowed min-w-[40px]"
      ...
      <div className="flex-1 flex items-center gap-3">
        ...
        <input
          ...
          disabled={disabled}
          className="flex-1 h-1.5 bg-gray-700 rounded-full appearance-none cursor-pointer accent-amber-500 disabled:opacity-30"
        />
      </div>
